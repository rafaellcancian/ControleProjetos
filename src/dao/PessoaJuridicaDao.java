...
public class PessoaJuridicaDao implements ClienteDao {
    ...
    public int inserir(Cliente cliente) {
        ...
        Object parCliente[] = {pessoaJuridica.getEndereco(), pessoaJuridica.getEmail(), pessoaJuridica.getFone()};
    ...
    public int alterar(Cliente cliente) {
        PessoaJuridica pessoaJuridica = (PessoaJuridica) cliente;
        Object parCliente[] = {pessoaJuridica.getEndereco(), pessoaJuridica.getEmail(), pessoaJuridica.getFone(), pessoaJuridica.getIdCliente()};
        PreparedStatement pstmt = null;
        ...
        try {
            ...
            Object parPessoaJuridica[] = {pessoaJuridica.getCnpj(), pessoaJuridica.getNomeFantasia(), pessoaJuridica.getRazaoSocial(), pessoaJuridica.getIdCliente()};
    ...
    public List<PessoaJuridica> getLista() {
        try {
            ...
            String sql1 = "SELECT * FROM Cliente INNER JOIN PessoaJuridica "
                + "ON (idCliente = idPessoaJuridica) ORDER BY NomeFantasia";
    ...
    public Cliente getClienteId(int id) {
        try {
            ...
            String sql1 = "SELECT * FROM Cliente INNER JOIN PessoaJuridica "
                + "ON (idCliente = idPessoaJuridica) WHERE idCliente=?";
            PreparedStatement pstmt = con.prepareStatement(sql1);
            pstmt.setInt(1, id);
            ResultSet rs = pstmt.executeQuery();
            while (rs.next()) {
    ...
    public List<PessoaJuridica> getClienteNome(String nome) {
        try {
            List<PessoaJuridica> lstPessoaJuridica = new ArrayList<>();
            String sql1 = "SELECT * FROM Cliente INNER JOIN PessoaJuridica Pj "
                + "ON (idCliente = idPessoaJuridica) WHERE Pj.nomeFantasia LIKE ?";
            PreparedStatement pstmt = con.prepareStatement(sql1);
    ...
    public List<PessoaJuridica> getClienteEmail(String email) {
        try {
            List<PessoaJuridica> lstPessoaJuridica = new ArrayList<>();
            String sql1 = "SELECT * FROM Cliente INNER JOIN PessoaJuridica "
                + "ON (idCliente = idPessoaJuridica) WHERE email LIKE ?";
            PreparedStatement pstmt = con.prepareStatement(sql1);
    ...
    public List<PessoaJuridica> getClienteFone(String fone) {
        try {
            List<PessoaJuridica> lstPessoaJuridica = new ArrayList<>();
            String sql1 = "SELECT * FROM Cliente INNER JOIN PessoaJuridica "
                + "ON (idCliente = idPessoaJuridica) WHERE fone LIKE ?";
            PreparedStatement pstmt = con.prepareStatement(sql1);
